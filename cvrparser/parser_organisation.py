...
from .sql_help import SessionUpdateCache as UpdateCache
...
class OrganisationNavnParser(ParserInterface):
    ...
    def __init__(self, key_store=set()):
        ...
        self.db = UpdateCache(table_class=table, data_columns=data_columns, key_columns=key_columns)
...
class OrganisationMemberParser(ParserInterface):
    ...
    def __init__(self):
        ...
        self.db = UpdateCache(table_class=table, key_columns=key_columns, data_columns=data_columns)
